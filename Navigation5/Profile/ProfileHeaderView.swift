...
final class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    private func setupStatusTextField() {
        ...
        statusTextField.attributedPlaceholder = NSAttributedString.init(string: "Set your status", attributes: [NSAttributedString.Key.foregroundColor: UIColor.darkGray])
